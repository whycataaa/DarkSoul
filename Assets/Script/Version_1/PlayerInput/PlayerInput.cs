...
public class PlayerInput : SingletonMono<PlayerInput>
{
    ...
    public bool IsAttack=>playerInputAsset.GamePlay.RMouse.WasPressedThisFrame();
    public bool IsDefense=>playerInputAsset.GamePlay.LMouse.IsPressed();
    public bool IsWeapon1=>playerInputAsset.GamePlay.Num1.IsPressed();
    public bool IsWeapon2=>playerInputAsset.GamePlay.Num2.IsPressed();
